HelloWorld. C Tutorials. Rad Studio IDE. Simple Input/Output. Windows API. DialogBased GUI Application. 
...
HelloWorld. Занятия по C. ИС Embarcadero Rad Studio. Windows API. Простой Ввод-Вывод. 
